...
#getInstance( "messagebox@cbmessagebox" ).renderMessage("success","Congratulations, you can see this page since you have the ""view"" permission.")#
...
<dl class="row">
  ...
  <dd class="col-sm-9">
    <dl class="row">
      ...
      <dd class="col-sm-8">"View" &ndash; this event requires the "view" permission since the event function itself is annotated with '<em>secured="view"</em>'</dd>
    </dl>
  </dd>
</dl>
