...
#getInstance( "messagebox@cbmessagebox" ).renderMessage("success","Congratulations, you can see this page since you have the ""create"" permission.")#
...
<dl class="row">
  ...
  <dd class="col-sm-9">
    <dl class="row">
      ...
      <dd class="col-sm-8">"Create" &ndash; this event requires the "create" permission since the event function itself is annotated with '<em>secured="create"</em>'</dd>
    </dl>
  </dd>
</dl>
