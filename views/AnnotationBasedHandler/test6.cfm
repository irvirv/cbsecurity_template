...
#getInstance( "messagebox@cbmessagebox" ).renderMessage("success","Congratulations, you can see this page since you have the ""modify"" permission.")#
...
<dl class="row">
  ...
  <dd class="col-sm-9">
    <dl class="row">
      ...
      <dd class="col-sm-8">"modify" &ndash; this event requires the "modify" permission since the event function itself is annotated with '<em>secured="modify"</em>'</dd>
    </dl>
  </dd>
</dl>
