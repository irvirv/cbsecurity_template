...
#getInstance( "messagebox@cbmessagebox" ).renderMessage("success","Congratulations, you can see this page since you have either the ""create"" or ""update"" permission.")#
...
<dl class="row">
  ...
  <dd class="col-sm-9">
    <dl class="row">
      ...
      <dd class="col-sm-8">"Create" or "Update" &ndash; this event requires either the "create" or "update" permission since the event 
        function itself is annotated with '<em>secured="create,update"</em>'.  Note it's a list and it's "OR".</dd>
    </dl>
  </dd>
</dl>
